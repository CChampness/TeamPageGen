...
describe("Engineer", () => {
    describe("Initialization", () => {
      it("should create an object with string properties 'name', 'id', 'email', and 'school'", () => {
        const engineer = new Engineer("Bob", 1, "Bob@junkmail.com", "FSU");
  
        // Verify that the new object has the correct properties
        expect(dayCare).toEqual({ name: "Bob", id: "1", email: "Bob@junkmail.com", school: "FSU" });
      });
    });
    ...
    describe("getName", () => {
      ...
      it("should have the engineer's id as '2'", () => {
        const engineer = new Engineer("Joe", "2", "Joe@junkmail.com", "FSU");
      ...
      it("should have the engineer's email as 'Jon@junkmail.com'", () => {
        const engineer = new Engineer("Jon", "3", "Jon@junkmail.com", "FSU");
      ...
      it("should have the engineer's role as 'engineer'", () => {
        const engineer = new Engineer("Rob", "4", "Rob@junkmail.com", "FSU");
